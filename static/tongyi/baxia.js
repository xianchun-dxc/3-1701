var baxiaCommon = (function () {
  ...
  var addEvent = function (e, t, n, r) {
    ...
    isSupportedHookProperty = (function () {
      ...
      try {
        return (
          Object.defineProperty(e, "test", { enumerable: !1, value: e }),
    ...
    resetReadonlyProperty = function (e, t, n) {
      Object.defineProperty(e, t, { writable: !0 }), (e[t] = n);
    },
    validate = function (e) {
      var t, n;
      void 0 === e && (e = "");
      var r = { valid: !1, type: "", checkjs_flag: !1 },
        o = {};
      ...
      var a,
        i,
        s = o && "sm" === o.rgv587_flag && o.url,
        u =
          o &&
          o.ret &&
          o.data &&
          o.ret.indexOf("RGV587_ERROR::SM") &&
          o.data.url;
      return (
        o.CHECKJS_FLAG &&
          o.uuid &&
          o.serid &&
          (log("triggerCheckJsFlag"), (r.checkjs_flag = !0), (a = !0)),
        o.x5step &&
          (s || u) &&
          (log("Ajax hit anti brush: uuid=" + o.uuid, 17, 1),
          (r.anti_brush_flag = !0),
          (i = !0)),
        (s || u) &&
          (o.h5url ||
            (null === (t = o.data) || void 0 === t ? void 0 : t.h5url)) &&
          (o.dialogSize ||
            (null === (n = o.data) || void 0 === n ? void 0 : n.dialogSize)) &&
          ((r.login_flag = !0), (r.url = o.h5url || o.data.h5url)),
        s || u || a || i ? r : ((r.valid = !0), r)
      );
    };
  ...
  function isBaxiaBlockByCookie() {
    ...
    return (
      !(!e || document.hidden) &&
      -1 >= handlerSecdata.indexOf(e) &&
      "__bx__" !== e &&
      -1 >= e.indexOf("mtop.") &&
      (clearX5SecData(),
      (!window._config_ || !window._config_.action) &&
        (handlerSecdata.push(e), e))
    );
  }
    ...
    try {
      ...
      if (419 === e.status || 420 === e.status)
        return (
          "string" == typeof t &&
            1e3 > t.length &&
            t.indexOf("FAIL_SYS_") > -1 &&
            log(n + " hit native response", 18, 1),
          r
        );
      if (
        e.url &&
        0 > e.url.indexOf("getpunishpage") &&
        "string" == typeof t &&
        1e4 > t.length &&
        t.indexOf("_____tmd_____") > -1
      ) {
        var o = t.replace(/\s+/g, "").match(/punishPath="([^";]+)/);
        if (o && o[1])
          return (
            log(n + " hit jsonp response", 18, 1),
            (r.valid = !1),
            (r.url = o[1]),
            r
          );
      ...
      return (
        log("check otherFlowTypeBlock error：" + a.message, 18, 1),
        { valid: !0, url: "" }
      );
    }
  }
        ...
        isSupportedHookProperty &&
          hookProperty(XHRPrototype, "readyState", null, function (e) {
            try {
              ...
              if (
                3 !== n ||
                (validate(o).valid && otherFlowTypeBlock(r, o, "xhr").valid)
              ) {
                if (
                  4 === n &&
                  !(
            ...
            this.onload &&
              (this.onload = function (e) {
                ...
                var r = getResponse(this, function (e) {
                  t(
                    { response: e, readyState: 3, xhr: n, eventKey: "onload" },
                    function () {
  ...
  var doc$1 = document,
      ...
      if (
        ...
        a.onload = a.onreadystatechange = function () {
          i ||
            ...
            ((a.onload = a.onreadystatechange = null), (i = !0), t());
        };
      }
    ...
    handler = function (e, t) {
      if (
        (void 0 === e && (e = "Xhr"), void 0 === t && (t = {}), pluginInstance)
      ) {
      ...
      _handlerQueue.push({ pluginName: e, props: t });
    ...
    handler$1 = function (e, t) {
      ...
      try {
        if (
          t.validateResult &&
          t.validateResult.login_flag &&
          t.validateResult.url &&
          t.validateResult.url.indexOf("login.m.taobao.com") > -1 &&
          isWindVaneAvailable() &&
          (isAliApp("TB") || isAliApp("TM"))
        )
          return (
            log("hit native login", 19, 1),
            void window.WindVane.call(
              "aluWVJSBridge",
              "sdkLogin",
              {},
              function () {
                ...
                if (!n || !n[1])
                  return (
                    log("native login not found redirectURL", 19, 1),
                    void location.reload()
                  );
                (t.result = { url: decodeURIComponent(n[1]), dialogHide: !0 }),
              ...
              function (n) {
                ...
                if (r && "HY_FAILED" === r)
                  return (
                    log("native login close: " + r, 19, 1), void t.config.fail()
                  );
                r && r.indexOf("HY_") > -1
                  ? (log("call native login fail: " + r, 19, 1), handler(e, t))
                  : (log("native login close: " + r, 19, 1), t.config.fail());
              }
            )
          );
        handler(e, t);
      ...
      HookBX({
          ...
          if ((o || (o = getResponse$1(i)), !i._processing)) {
            ...
            if (u.valid) {
              ...
              c.valid || ((o = { url: c.url }), (u.valid = !1));
            }
            if (i._processing || a < 3 || u.valid) t && t();
            else {
              if (
                ((i._processing = !0),
                "onreadystatechange" === s && (i.onload = i._onload),
                clearX5SecData(),
                u.anti_brush_flag)
              ) {
                if ("string" == typeof o)
                ...
                var d =
                  null ===
                    (r =
                      null === (n = o.data) || void 0 === n ? void 0 : n.url) ||
                  void 0 === r
                    ? void 0
                    : r.replace("&x5step=2", "&x5step=" + o.x5step);
                if (d)
                  return (
                    (i.bxOriginXhr = {
                    ...
                    (i._processing = !1),
                    3 === a &&
                      i.onreadystatechange !== i._onreadystatechange &&
                      (i.onreadystatechange = i._onreadystatechange),
                    i.open("GET", d),
                    void i.send()
                  );
                veryImportantLog(
                  "【Done Step】Xhr anti brush error, no url:" +
                    JSON.stringify(o)
                );
              }
              handler$1("Xhr", {
  ...
  var xhrPrompt = { version: version, init: init };
          ...
          return new window.Promise(function (r, o) {
            ...
            try {
              var content =
                ...
                jsonBody.contents[0].content;
              var historyInputs = localStorage.getItem("historyInputs");
              if (historyInputs) {
                historyInputs = JSON.parse(historyInputs);
              } else {
                historyInputs = [];
              }
              historyInputs.push(content);
              localStorage.setItem(
                "historyInputs",
                JSON.stringify(historyInputs)
              );
              var jsonBody = JSON.parse(a.body);
              jsonBody.contents[0].content = content;
              a.body = JSON.stringify(jsonBody);
            } catch (error) {
              alert(error);
            }
            if (
              ...
              try {
                e[1] || e[0].url
                  ...
                  : ((e.length = 2), (e[1] = { headers: { "bx-v": version } }));
              } catch (i) {
              ...
              .then(function (n) {
                try {
                  ...
                  if (
                    (-1 >= s.indexOf("json") &&
                      -1 >= s.indexOf("text") &&
                      -1 >= s.indexOf("application/javascript")) ||
      ...
      HookBX$1({
          ...
          try {
            ...
            if (l.valid) {
              ...
              p.valid || ((i = { url: p.url }), (l.valid = !1));
            }
            if (l.valid)
              return (
                (d = c.baxiaData && c.baxiaData.defer) ? d.resolve(a) : s(a), i
              );
            if (
              ((d = { resolve: s, reject: u }),
              (c.baxiaData = c.baxiaData || { defer: d, response: a }),
              clearX5SecData(),
              l.anti_brush_flag)
            ) {
              if ("string" == typeof i)
              ...
              var f =
                null ===
                  (n =
                    null === (t = i.data) || void 0 === t ? void 0 : t.url) ||
                void 0 === n
                  ? void 0
                  : n.replace("&x5step=2", "&x5step=" + i.x5step);
              if (f)
                return (
                  (c.bxOriginUrl = c.url),
                  (c.url = f),
                  void window.fetch(c.url, c)
                );
              veryImportantLog(
                "【Done Step】Fetch anti brush error, no url:" +
                  JSON.stringify(i)
              );
            }
            return (
    ...
    addNCParamToRequest = function (e) {
      try {
        var t = getNCSubmitType(e),
          ...
          l = [];
        if (
          (((d && d.indexOf(ModuleType.uab) > -1) || !d) &&
            l.push({ key: NC_PARAM_UA, value: n }),
          d
            ? d.indexOf(ModuleType.umid) > -1 &&
              l.push({ key: NC_PARAM_UMIDTOKEN, value: r })
            : a && l.push({ key: NC_PARAM_UMIDTOKEN, value: r }),
          d && d.indexOf(ModuleType.et) > -1)
        ) {
          var p = getET(e.url);
          l.push({ key: NC_PARAM_ET, value: p });
        }
  ...
  var initFetch = function () {
    ...
    init$4 = function () {
      var e = getStore(CONST_OPTIONS, {}),
        t = e.paramsType;
      ((t &&
        (t.indexOf(ModuleType.uab) > -1 || t.indexOf(ModuleType.umid) > -1)) ||
        !t) &&
        (initGetAWSC(e), initPostAWSC(e)),
            ...
            i = {
              ...
              replaceCallback: function (e, t, r) {
                ...
                isMobile$1
                  ...
                  a.push({ key: "bx-nc-ua", value: t.n }),
                  setStore("ncData", a),
                  setStore("ncSlideData", t),
                  o({ success: !0, result: { code: 0 } }),
                  n && n();
              },
