!(function (e, t) {
  ...
  function fe(t) {
    if (!r(t) || !p(t.callbackName))
      return Wi.log("JSONP \u8bf7\u6c42\u7f3a\u5c11 callbackName"), !1;
    ...
    if (document && p(e)) {
      if (0 === e.indexOf("http")) {
        var i = Le(e),
          a = F(e);
        if (oe(a))
          return pa.preset_properties.search_keyword_baidu && Ie()
            ? void 0
            : "\u672a\u53d6\u5230\u503c";
        var o = null;
        for (var s in n)
  ...
  function He(e, t, n) {
    ...
    return (
      r(pa.heatmap) && h(pa.heatmap.useCapture) && "click" === t && (i = !0),
      b(e, t, n, i)
    );
  }
  function Be() {
  ...
  function Ve(e) {
    ...
    r &&
      pa.preset_properties.url &&
      h(e.properties.$url) &&
      (e.properties.$url = Z()),
      r &&
        pa.preset_properties.title &&
  ...
  function ze(t) {
    var r =
      pa.heatmap && e(pa.heatmap.collect_input) && pa.heatmap.collect_input(t);
  ...
  function et(e, t) {
    for (var r in e)
      if (Object.prototype.hasOwnProperty.call(e, r) && !xa.check(r, e[r], t))
        return !1;
    return !0;
  }
  function tt(t, n) {
  ...
  function mt() {
    ...
    return (
      k(e, function (e, r, n) {
        (" " + Fi.source_channel_standard + " ").indexOf(" " + r + " ") !== -1
          ? (t["$" + r] = n[r])
          : (t[r] = n[r]);
      }),
      t
  ...
  function bt(e, t) {
    ...
    "string" == typeof e &&
      e in Za.EVENT_LIST &&
      ((r = Za.EVENT_LIST[e]), Za[r[0]].on(r[1], t));
  }
  function wt(e, t) {
    var n = e.id,
      i = e.callback,
    ...
    if (n === $a.getOriginDistinctId() && !o)
      return je("login id is equal to distinct_id"), !1;
    if (
      r($a._state.identities) &&
      $a._state.identities.hasOwnProperty(a) &&
      n === $a._state.first_id
    )
      return !1;
    var l =
      $a._state.history_login_id.name !== a ||
      n !== $a._state.history_login_id.value;
    if (l) {
  ...
  function kt(e, t) {
    ...
    if (
      r($a._state.identities) &&
      $a._state.identities.hasOwnProperty(e) &&
      ...
      n &&
        ...
        "$identity_cookie_id" !== e &&
          (delete $a._state.identities[e], $a.save());
    }
    var i = {};
    return (i[e] = t), i;
  }
  function Pt() {
    (Fi._t = Fi._t || 1 * new Date()),
      (Fi.is_first_visitor = !1),
      (Fi.source_channel_standard = fa);
  }
  function Ct(e) {
    P(pa, e || Fi.para || {}), (Fi.para = pa);
    var t = {};
    if (r(Fi.para.is_track_latest))
      for (var n in Fi.para.is_track_latest)
        t["latest_" + n] = Fi.para.is_track_latest[n];
    Fi.para.preset_properties = P(
      {},
      da.preset_properties,
      t,
    ...
    "object" == typeof Fi.para.source_type &&
      ((Fi.para.source_type.utm = v(Fi.para.source_type.utm)
        ? Fi.para.source_type.utm.concat(a)
        : a),
      (Fi.para.source_type.search = v(Fi.para.source_type.search)
        ? Fi.para.source_type.search.concat(o)
        : o),
      (Fi.para.source_type.social = v(Fi.para.source_type.social)
        ? Fi.para.source_type.social.concat(s)
        : s),
      (Fi.para.source_type.keyword = r(Fi.para.source_type.keyword)
        ? P(l, Fi.para.source_type.keyword)
        : l));
    var u = { div: !1 },
      c = [
        "mark",
    ...
    if (
      (Fi.para.heatmap && !r(Fi.para.heatmap) && (Fi.para.heatmap = {}),
      r(Fi.para.heatmap))
    ) {
      (Fi.para.heatmap.clickmap = Fi.para.heatmap.clickmap || "default"),
        (Fi.para.heatmap.scroll_notice_map =
          Fi.para.heatmap.scroll_notice_map || "default"),
        (Fi.para.heatmap.scroll_delay_time =
          Fi.para.heatmap.scroll_delay_time || 4e3),
        (Fi.para.heatmap.scroll_event_duration =
          Fi.para.heatmap.scroll_event_duration || 18e3),
        (Fi.para.heatmap.renderRefreshTime =
          Fi.para.heatmap.renderRefreshTime || 1e3),
        (Fi.para.heatmap.loadTimeout = Fi.para.heatmap.loadTimeout || 1e3),
        Fi.para.heatmap.get_vtrack_config !== !0 &&
          (Fi.para.heatmap.get_vtrack_config = !1);
      ...
      if (
        ...
        (Fi.para.heatmap.track_attr = p),
        r(Fi.para.heatmap.collect_tags))
      )
        if (Fi.para.heatmap.collect_tags.div === !0)
          Fi.para.heatmap.collect_tags.div = { ignore_tags: c, max_level: 1 };
          ...
          if (
            ...
            var d = [1, 2, 3];
            re(d, Fi.para.heatmap.collect_tags.div.max_level) === -1 &&
              (Fi.para.heatmap.collect_tags.div.max_level = 1);
          }
    ...
    (Fi.para.server_url = Ge(Fi.para.server_url)),
      Fi.para.noCache === !0
        ? (Fi.para.noCache = "?" + new Date().getTime())
        : (Fi.para.noCache = ""),
      Fi.para.callback_timeout > Fi.para.datasend_timeout &&
        (Fi.para.datasend_timeout = Fi.para.callback_timeout),
      Fi.para.heatmap &&
      ...
      Fi.para.heatmap &&
        "default" === Fi.para.heatmap.clickmap &&
        Fi.heatmap.initUnlimitedTags();
  }
  function Ot() {
  ...
  function Nt(t, n) {
    ...
    if (!p(t) && !r(t))
      return void je("use's first arguments must be string or object.");
    var a;
    if (r(t)) {
    ...
    return (
      ...
      a && e(a.init)
        ? a.plugin_is_init
          ? a
          : (a.plugin_name ||
              Ne("warning: invalid plugin, plugin_name required."),
            a.plugin_version
  ...
  function jt(e, t, r) {
    et({ event: e, properties: t }) &&
      qa.send({ type: "track", event: e, properties: t }, r);
  }
  function Tt(e, t) {
    return (
  ...
  function xt(e, t) {
    et({ item_type: e, item_id: t }) &&
      qa.sendItem({ type: "item_delete", item_type: e, item_id: t });
  }
  function Et(e, t) {
    et({ propertiesMust: e }) &&
      qa.send({ type: "profile_set", properties: e }, t);
  }
  function Lt(e, t) {
    et({ propertiesMust: e }) &&
      qa.send({ type: "profile_set_once", properties: e }, t);
  }
  function Ut(e, t) {
    et({ propertiesMust: e }) &&
      (k(e, function (t, r) {
  ...
  function Ht(e) {
    qa.send({ type: "profile_delete" }, e),
      $a.set("distinct_id", Zi()),
      $a.set("first_id", "");
  }
  function Bt(e, t) {
    var r = e,
  ...
  function Vt(e) {
    ...
    if (v(e) && e.length > 0)
      for (t = 0; t < e.length; t++)
        p(e[t]) && e[t] in ba.currentProps && delete ba.currentProps[e[t]];
  ...
  function tr() {
    ...
    Fi.heatmap &&
      ...
      le() &&
        ...
        Fi.para.heatmap &&
          Fi.para.heatmap.track_attr &&
          be("[" + Fi.para.heatmap.track_attr.join("], [") + "]" + t),
        "" !== e && be(e));
  }
  function rr(e) {
    var t = this;
      ...
      (pa.preset_properties.search_keyword_baidu
        ? xe(document.referrer) &&
          (!Ie() || (r(n) && n.active)
            ? $a._state &&
              $a._state.props &&
              ($a._state.props.$search_keyword_id &&
                delete $a._state.props.$search_keyword_id,
              $a._state.props.$search_keyword_id_type &&
                delete $a._state.props.$search_keyword_id_type,
              $a._state.props.$search_keyword_id_hash &&
                delete $a._state.props.$search_keyword_id_hash)
  ...
  function lr(e) {
    function t() {
      ...
      n.touch_app_bridge || e.push(ya.defineMode("1")),
        r(Fi.para.app_js_bridge) ||
          (e.push(ya.defineMode("2")), (n.verify_success = !1)),
        (r(Fi.para.heatmap) && "default" == Fi.para.heatmap.clickmap) ||
          e.push(ya.defineMode("3")),
                ...
                success: function () {
                  setTimeout(function () {
                    "undefined" != typeof sa_jssdk_app_define_mode &&
                      window.sa_jssdk_app_define_mode(Fi, e);
                  }, 0);
                },
                error: function () {},
                type: "js",
  ...
  function gr() {
    k(io, function (t) {
      var r = Fi[t];
      Fi[t] = function () {
        return Fi.readyState.state < 3
          ? (v(Fi._q) || (Fi._q = []),
            Ne("calling sdk api before init is deprecated."),
            Fi._q.push([t, arguments]),
            !1)
          : e(Fi.getDisabled) && Fi.getDisabled()
          ? void 0
          : Fi.readyState.getState()
    ...
    if (
      ...
      if (
        ($o &&
          (e = !!$o.call(
            jo,
            JSON.stringify({ server_url: Ao.para.server_url })
          )),
        (Ao.bridge.bridge_info = {
          touch_app_bridge: !0,
          platform: "android",
  ...
  function zr(e, t) {
    ...
    if (Io) {
      var n =
        ...
        Io.call(
          jo,
          JSON.stringify(Do.extend({ server_url: Ao.para.server_url }, e.data))
        );
      return n
  ...
  var Vi,
    Wi = {
      ...
      log: function () {
        (Vi || (console && console.log) || function () {}).apply(
          null,
          arguments
        );
      }
      ...
      : (zi.set(s, JSON.stringify({ randomNum: u, expireTime: t() + r })),
        void setTimeout(function () {
          (l = i(zi.get(s)) || { randomNum: 0, expireTime: 0 }),
            l && l.randomNum === u
              ? (o(zi.get(e)), zi.remove(e), zi.remove(s))
              : o(null);
        }, a));
  }),
  ...
  (da.white_list = {}),
    (da.white_list[location.host] = g(location.href).hostname);
        ...
        null != n &&
          ...
          Fi.para.cross_subdomain === !0
            ...
            : ((i.$device_id = r),
              ...
              ma.set(
                "sensorsdata2015jssdkcross" + Fi.para.sdk_id,
                i,
                null,
                !0
              )),
  ...
  Ye.prototype = {
    ...
    getServerUrl: function () {
      return (p(pa.server_url) && "" !== pa.server_url) ||
        (v(pa.server_url) && pa.server_url.length)
        ? void (this.serverUrl = v(pa.server_url)
            ? pa.server_url[0]
            : pa.server_url)
        : je(
            "\u5f53\u524d server_url \u4e3a\u7a7a\u6216\u4e0d\u6b63\u786e\uff0c\u53ea\u5728\u63a7\u5236\u53f0\u6253\u5370\u65e5\u5fd7\uff0cnetwork \u4e2d\u4e0d\u4f1a\u53d1\u6570\u636e\uff0c\u8bf7\u914d\u7f6e\u6b63\u786e\u7684 server_url\uff01"
    ...
    send: function () {
      if (
        !(
          this.sendTimeStamp &&
          t() - this.sendTimeStamp < pa.batch_send.datasend_timeout
        )
      ) {
    ...
    remove: function (e) {
      ...
      if (t) {
        ...
        (r = Ce(r)),
          zi.set(this.tabKey, JSON.stringify(this.generateTabStorageVal(r)));
      }
    },
    add: function (e) {
      var r = Ca + String(n()),
    ...
    generateTabStorage: function () {
      (this.tabKey = Oa + String(n())),
        zi.set(this.tabKey, JSON.stringify(this.generateTabStorageVal()));
    },
    generateTabStorageVal: function (e) {
      return (
        ...
        {
          data: e,
          expireTime: t() + 2 * pa.batch_send.send_interval,
    ...
    recycle: function () {
      for (
        ...
        if (0 === s.indexOf(Oa)) {
          for (
            var u = i(zi.get(s)) || this.generateTabStorageVal(), c = 0;
            c < u.data.length;
            c++
          )
            e[u.data[c]] = !0;
            ...
            p.get(s, r, 1e3, function (e) {
              if (e) {
                ...
                (r.data = Ce(r.data.concat(t.data))),
                  zi.set(l.tabKey, JSON.stringify(r));
              }
            });
          }
  ...
  var Ta = {
    ...
    $a = {
      ...
      setProps: function (e, t) {
        ...
        for (var n in r)
          "string" == typeof r[n] &&
            (r[n] = r[n].slice(0, Fi.para.max_referrer_string_length));
        this.set("props", r);
      },
      ...
      sessionSave: function (e) {
        ...
        Fi.para.encrypt_cookie && (t = Fi.kit.userEncrypt(t)),
          ma.set("sensorsdata2015session", t, 0);
      },
      save: function () {
      ...
      saveObjectVal: function (e, t) {
        p(t) || (t = JSON.stringify(t)),
          1 == Fi.para.encrypt_cookie && (t = Fi.kit.userEncrypt(t)),
          zi.set(e, t);
      },
    ...
    xa = {
      ...
      event: {
        ...
        onComplete: function (t, r, n) {
          return (
            t ||
              ("emptyString" === n && (r = "eventName"), e(Aa[n]) && Aa[n](r)),
            !0
          );
        }
      },
      ...
      item_type: {
        ...
        onComplete: function (t, r, n) {
          return (
            t ||
              ("emptyString" === n && (r = "item_type"), e(Aa[n]) && Aa[n](r)),
            !0
          );
        }
      },
      item_id: {
        ...
        onComplete: function (t, r, n) {
          return (
            t || ("emptyString" === n && (r = "item_id"), e(Aa[n]) && Aa[n](r)),
            !0
          );
        }
      },
    ...
    (Ea.configIsMatch = function (e, t) {
      return (
        ...
        (t.element_field && t["function"]
          ? Ea.configIsMatchNew(e, t)
          : Ea.configIsMatchOldVersion(e, t))
      );
    }),
  ...
  var La = {
    ...
    Ua = {
      ...
      initAppUpdateConfigBridge: function () {
        var e = this;
        return new Fi.SDKJSBridge("updateH5VisualConfig").onAppNotify(function (
          t
        ) {
          if (t) {
            try {
      ...
      isTargetEle: function (e) {
        ...
        for (var n = 0; n < this.events.length; n++)
          if (
            ...
            Ba.configIsMatch(t, this.events[n].event)
          )
            return !0;
        return !1;
      }
    ...
    Ba = {
      ...
      init: function () {
        if (!r(Fi.para.heatmap) || !Fi.para.heatmap.get_vtrack_config)
          return !1;
    ...
    (qa.sendItem = function (e) {
      var t = {
        lib: {
          $lib: "js",
          $lib_method: "code",
          $lib_version: String(Fi.lib_version)
        },
        time: 1 * new Date()
      };
  ...
  var Ka = {
    ...
    Va = {
      ...
      start: function (t, n, i, a, o) {
        if (
          r(Fi.para.heatmap) &&
          e(Fi.para.heatmap.collect_element) &&
          !Fi.para.heatmap.collect_element(n)
        )
          return !1;
      ...
      initScrollmap: function () {
        if (
          !r(Fi.para.heatmap) ||
          "default" !== Fi.para.heatmap.scroll_notice_map
        )
          return !1;
        var t = !0;
        Fi.para.scrollmap &&
        ...
        var n = function (e) {
          ...
          i = n({
            ...
            func: function (e, t) {
              ...
              ((i > Fi.para.heatmap.scroll_delay_time &&
    ...
    Wa = {
      ...
      isReady: function (t) {
        return e(t)
          ? void t()
          : void Fi.log("error: isReady callback must be function");
      },
      getUtm: function () {
      ...
      setProfileLocal: function (e) {
        ...
        if (r(t) && !oe(t)) {
          ...
          n &&
            ($a.saveObjectVal("sensorsdata_2015_jssdk_profile", t),
            Fi.setProfile(e));
        } else
          $a.saveObjectVal("sensorsdata_2015_jssdk_profile", e),
            Fi.setProfile(e);
      },
      setInitReferrer: function () {
        ...
        Fi.setOnceProfile({
          _init_referrer: e,
          _init_referrer_host: ba.pageProp.referrer_host
        });
      },
      setSessionReferrer: function () {
        var e = De();
        $a.setSessionPropsOnce({
          _session_referrer: e,
          _session_referrer_host: ba.pageProp.referrer_host
        });
      },
      setDefaultAttr: function () {
        ba.register({
          ...
          _referrer: De(),
          _referring_host: ba.pageProp.referrer_host
        });
      },
      trackHeatMap: function (e, t, r) {
        if ("object" == typeof e && e.tagName && _(e.parentNode)) {
          var n = e.tagName.toLowerCase(),
            ...
            a =
              Fi.para.heatmap && Fi.para.heatmap.track_attr
                ? Fi.para.heatmap.track_attr
                : ["data-sensors-click"];
          "button" === n ||
            "a" === n ||
      ...
      autoTrackSinglePage: function (e, t) {
        ...
        var i;
        (i = this.autoTrackIsUsed ? ba.pageProp.url : ba.pageProp.referrer),
          (e = r(e) ? e : {});
      ...
      getAnonymousID: function () {
        return oe($a._state)
          ...
          : $a._state._first_id ||
              $a._state.first_id ||
              $a._state._distinct_id ||
              $a._state.distinct_id;
      },
  ...
  var eo = P({}, la, Ta),
    to = {
      ...
      initPara: function () {
        var e = {
          is_send:
            Fi.para.use_app_track_is_send !== !1 &&
                ...
                setTimeout(function () {
                  "undefined" != typeof sa_jssdk_heatmap_render &&
                    ...
                    "object" == typeof console &&
                      ...
                      ((Fi.heatmap_version &&
                        Fi.heatmap_version === Fi.lib_version) ||
                        Ne(
  ...
  (mr.prototype.process = function (e, t) {
    if (!(e && e in this.processDef))
      return void je("process [" + e + "] is not supported");
    var r = this.registeredInterceptors[e];
    if (r && v(r) && r.length > 0)
      for (
        var n = { current: 0, total: r.length }, i = new hr(t, n, Fi), a = 0;
        a < r.length;
        a++
      )
        try {
  ...
  var So,
    ...
    Zo = {
      ...
      commands: {
        ...
        visualized_track: Dr,
        page_info: Dr,
        sensorsdata_get_app_visual_config: xr
      }
    },
    Go = "1.25.13",
    Qo = {
      init: function (e) {
        (Co = e),
          (Oo = Co && Co._),
          (No = (Co && Co.log) || (console && console.log) || function () {}),
          Rr();
      },
      handleCommand: Br
    },
    ...
    is = {
      ...
      commands: {
        ...
        visualized_track: Mr,
        page_info: Mr,
        sensorsdata_get_app_visual_config: qr
      }
    },
    as = "1.25.13",
    os = {
      init: function (e) {
        (Ao = e),
          (Do = Ao && Ao._),
          (xo = (Ao && Ao.log) || (console && console.log) || function () {}),
          Wr();
      },
      handleCommand: Xr
    },
